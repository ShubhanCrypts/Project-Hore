package com.cryptsproject.projecthorenews.adapter
...
class DummyAdapter : RecyclerView.Adapter<DummyAdapter.NewsViewHolder>() {
    inner class NewsViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView)


    private val differCallBack = object : DiffUtil.ItemCallback<ArticleDummy>(){
...
//            tvPublishedAt.text = article.publishedAt
    ...
    fun setOnItemClickListener(listener: (ArticleDummy) -> Unit){
        onItemClickListener = listener
    }

    private var onItemClickListener: ((ArticleDummy) -> Unit)? = null
}